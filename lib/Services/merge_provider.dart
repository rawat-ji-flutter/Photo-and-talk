...
import 'package:photo_talk/Common/const_paths.dart';
...
class MergeProvider with ChangeNotifier {
  ...
  // Future<void> mergeIntoVideo({var imagesPath}) async {
  ...
  //     String commandToExecute = '-r 30 -pattern_type sequence -start_number 01 -f image2 -i'
  //         ' ${imagesPath} -f mp3 -i ${Constants.AUDIO_PATH} -y ${Constants
  //         .OUTPUT_PATH}';
  //
